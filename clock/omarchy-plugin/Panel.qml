...
Panel {
  ...
  function setCenterHoverRevealSuppressed(value) {
    // Function first: a registered plugin's `bar` is a PluginBarApi, whose
    // centerHoverRevealSuppressed is read-only — assigning to it throws and
    // aborts this function, which in close() would skip controller.hide().
